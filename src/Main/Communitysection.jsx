...
const CommunityListItem = ({ title, description }) => {
  return (
    <div className="flex items-start space-x-4 mb-6">
      <div className="w-8 h-8 bg-gray-300 rounded-md opacity-70 mt-1"></div>
  ...
  return (
    <div className="bg-white font-sans text-gray-900 py-16 px-4 md:px-16 flex flex-col items-center">
      <div className="container mx-auto max-w-3xl text-center mb-16">
        <p className="text-sm font-semibold text-blue-600 uppercase mb-4">
          Community
        </p>
